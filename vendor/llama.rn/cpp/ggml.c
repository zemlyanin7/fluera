...
static const struct lm_ggml_type_traits type_traits[LM_GGML_TYPE_COUNT] = {
    ...
    [LM_GGML_TYPE_STQ1_0] = {
        ...
        .is_quantized             = true,
        .to_float                 = (lm_ggml_to_float_t) dequantize_row_stq1_0,
        .from_float_ref           = (lm_ggml_from_float_t) quantize_row_stq1_0_ref,
    },
};
...
size_t lm_ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case LM_GGML_TYPE_STQ1_0:  result = quantize_stq1_0 (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
