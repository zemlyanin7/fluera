...
typedef struct {
    ...
    lm_ggml_half d;           // scale
} block_stq1_0;
static_assert(sizeof(block_stq1_0) == sizeof(lm_ggml_half) + QK_K / 8 + QK_K / 32, "wrong stq1_0 block size/padding");
...
LM_GGML_TABLE_BEGIN(uint8_t, stq1_0_codebook, 32)
...
LM_GGML_TABLE_BEGIN(uint8_t, stq1_0_qpack_to_slot, 256)
...
LM_GGML_TABLE_BEGIN(uint8_t, stq1_0_qpack_to_sign, 256)
