...
# Rename jinja/parser.h to avoid case-insensitive collision with
# react-native-unistyles' cxx/parser/Parser.h on APFS macOS.
mv ./cpp/common/jinja/parser.h ./cpp/common/jinja/jinja-parser.h
mv ./cpp/common/jinja/parser.cpp ./cpp/common/jinja/jinja-parser.cpp
...
if [ "$OS" = "Darwin" ]; then
  ...
  sed -i '' 's|#include "parser.h"|#include "jinja-parser.h"|g' ./cpp/common/jinja/jinja-parser.cpp
  sed -i '' 's|#include "jinja/parser.h"|#include "jinja/jinja-parser.h"|g' ./cpp/common/chat.h
